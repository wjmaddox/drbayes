...
parser.add_argument('--rank', type=int, required=True, default=None, metavar='R',
                    help='rank (default: None)')
...
for param in model.parameters():
    size = param.numel()
    param.data.copy_(swag_model.mean[offset:offset+size].view(param.size()))
    offset += size
