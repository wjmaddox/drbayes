...
from swag.posteriors import SWAGFD, SWAGPCA
...
parser.add_argument('--fd', action='store_true', help='whether to use frequent directions or standard PCA')
...
fd = swag_class(model_cfg.base, *model_cfg.args, max_num_models = 20, num_classes = 100, **model_cfg.kwargs)
fd.cuda()
...
for path in args.checkpoint:
    ...
    fd.collect_model(model)
mean, var, sketch = fd.export_numpy_params(export_cov_mat = True)
